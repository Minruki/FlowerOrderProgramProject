...
import FlowerOrderProgramProject.dao.impl.Customer_informationDaoImpl;
...
//		customer_information customer_information = new customer_information("min");
		Customer_information selectedcustomer_information = dao.selectcustomer_informationByNo(new Customer_information("min"));
